...
MePage$QueryRoot$Users _$MePage$QueryRoot$UsersFromJson(
    Map<String, dynamic> json) {
  return MePage$QueryRoot$Users()..username = json['username'] as String;
}

Map<String, dynamic> _$MePage$QueryRoot$UsersToJson(
        MePage$QueryRoot$Users instance) =>
    <String, dynamic>{
      'username': instance.username,
    };

MePage$QueryRoot _$MePage$QueryRootFromJson(Map<String, dynamic> json) {
  return MePage$QueryRoot()
    ..me = (json['me'] as List)
        ?.map((e) => e == null
            ? null
            : MePage$QueryRoot$Users.fromJson(e as Map<String, dynamic>))
        ?.toList();
}

Map<String, dynamic> _$MePage$QueryRootToJson(MePage$QueryRoot instance) =>
    <String, dynamic>{
